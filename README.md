...
- **`/projects/bank-app-projects`** — **secure-banking-app** (AWS deploy case study) and **baawisan-banking-threat-model** (STRIDE / risk / mitigations). **`/projects/healthcare-app-projects`** — placeholder until you add repos.
